...
newMission=Mission()
readMissionFromFile(newMission, path_mission)

# extracting positions of artillery boundaries
zone_left_down_allies = findObject(newMission, Type='Vehicle', Name="Artillery_Zone_Allies_1")[0]
zone_right_up_allies = findObject(newMission, Type='Vehicle', Name="Artillery_Zone_Allies_2")[0]
...
zone_left_down_axis = findObject(newMission, Type='Vehicle', Name="Artillery_Zone_Axis_1")[0]
zone_right_up_axis = findObject(newMission, Type='Vehicle', Name="Artillery_Zone_Axis_2")[0]
...
lines = []
with open(path_mission, "r") as f:
    lines = f.readlines()
with open(path_mission, "w") as f:
    lines2 = lines[:-1]
    f.writelines(lines2)
    f.write(final_txt)
    f.write('# end of file')